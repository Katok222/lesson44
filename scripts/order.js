...
// Вывод ошибки и сброс подсчетов
...
calcButton.addEventListener('click', () => {
    ...
    mapRoute.model.events.add('requestsuccess', () => {
        ...
        try {
            ...
            const size =
                document
                    .querySelector('.main-size-card.is-active')
                    .dataset
                    .value;
            ...
            const speed =
                document
                    .querySelector('.main-speed-card.is-active')
                    .dataset
                    .value;
...
submitButton.addEventListener('click', async () => {
    ...
    if (!calculation) {
        ...
        alert(
            'Сначала рассчитайте стоимость, чтобы оформить заявку.'
        );
    ...
    if (!phone) {
        ...
        alert(
            'Введите корректный телефон (минимум 10 цифр)'
        );
    ...
    orderSuccessBlock.classList.add(
        'is-visible'
    );
});